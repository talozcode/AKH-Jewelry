    ...
    <SimplePage eyebrow="Help" title="Frequently Asked Questions">
      <Accordion
        items={[
          ...
          { title: "Are the materials genuine?", content: "Yes. We use sterling silver and 9–18k gold, set with genuine stones including Nigerian emeralds and white sapphires, hand-selected by the studio. Larger stones are independently certified (CGRL)." },
