...
export const metadata: Metadata = {
  ...
  description: "Internal comparison of four visual design directions for AKH — not part of the live site.",
  ...
  return (
    <div className="bg-ivory">
      ...
      <div className="mx-auto max-w-2xl px-6 pt-12 text-center">
        ...
        <h1 className="mt-2 font-display text-3xl text-ink">Four directions for AKH</h1>
        <p className="mt-3 text-sm text-ink/70">
          Same three real pieces, the same real story, four different design
