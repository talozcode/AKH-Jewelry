...
describe("buildAnonymizedOrderPatch", () => {
  it("touches exactly the allowlisted personal-data columns, nothing else", () => {
    const patch = buildAnonymizedOrderPatch({ id: "abc12345-0000-0000-0000-000000000000", shipping_line2: "Apt 4", shipping_state: "CA" });
    expect(Object.keys(patch).sort()).toEqual(EXPECTED_PATCHED_KEYS);
  });

  it("erases NOT NULL string columns unconditionally", () => {
    const patch = buildAnonymizedOrderPatch({ id: "abc12345-0000-0000-0000-000000000000", shipping_line2: null, shipping_state: null });
  ...
  it("generates a per-row unique, non-routable erased email using the order id", () => {
    const a = buildAnonymizedOrderPatch({ id: "aaaaaaaa-0000-0000-0000-000000000000", shipping_line2: null, shipping_state: null });
    const b = buildAnonymizedOrderPatch({ id: "bbbbbbbb-0000-0000-0000-000000000000", shipping_line2: null, shipping_state: null });
